	...
	<body class="homepage header-collapse">
		...
		<div id="site-content">
				...
				<div class="container">
					...
					<div class="main-navigation">
						...
						<ul class="menu">
							...
							<li class="menu-item current-menu-item"><a href="index.html"><strong>Home</strong></a></li>
							<li class="menu-item"><a href="create.php"><strong>Sell Products</strong></a></li>
							<li class="menu-item"><a href="gallery.html"><strong>Gallery</strong></a></li>
							<li class="menu-item"><a href="about.html"><strong>About</strong></a></li>

							<li class="menu-item"><a href="signin.php"><strong>Log in</strong></a></li>
			...
			<div class="hero hero-slider">
				<ul class="slides">
					<li data-bg-image="images/firstpage.jpg">
						<div class="container">
							<h3 class="slider-subtitle">Your header goes here</h3>
							<h2 class="slider-title">Register Today</h2>
							...
							<a href="register.php" class="button large">Sign Up</a>
						</div>
					</li>
					<li data-bg-image="images/sectionbeauty.jpg">
						<div class="container">
							<h3 class="slider-subtitle">Get Your Products</h3>
							<h2 class="slider-title">Facial products</h2>
					...
					<li data-bg-image="images/watchweight.jpeg">
						<div class="container">
							<h3 class="slider-subtitle">Enjoy free sessions for fitness </h3>
							<h2 class="slider-title">Healthy Lifestyle</h2>
							...
							<div class="col-md-4">
								<div class="news">
									<div class="entry-date">
										...
										<div class="monthyear">07.2021</div>
										<a href="https://www.elle.com/uk/beauty/hair/a36104985/freddie-harrel-hair-radswan-personal-essay/" role="button" target="blank" class="m-2">read more</a>
								
									</div>
									<div class="entry-detail">
										<div class="entry-summary">Freddie Harrel: 'Hair Is Where You Get To Be Loud' <a href="" class="more-icon"><img src="images/arrow.png"></a></div>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="news">
									<div class="entry-date">
										...
										<a href="https://www.elle.com/uk/fashion/trends/g32298/best-fashion-campaigns/" role="button" target="blank" class="m-2">read more</a>
									</div>
									<div class="entry-detail">
										<div class="entry-summary"><strong>Fashion Campaigns You Need To See</strong>
The latest fashion campaigns inspiring us right now.. <a href="#" class="more-icon"><img src="images/arrow.png"></a></div>
									</div>
								</div>
							</div>
							<div class="col-md-4">
						...
						<div class="text-center">
							<a href="https://www.elle.com/uk/contenttype/news/" target="blank" class="button no-gradient">More news</a>
						</div>
					</div> <!-- .container -->
						...
						<div class="row">
							<div class="col-md-3">
								<div class="feature">
									...
									<h3 class="feature-title"><strong><i>Body Care</i></strong></h3>
							...
							<div class="col-md-3">
								<div class="feature">
									...
									<h3 class="feature-title"><strong><i>Hair products</i></strong></h3>
							...
							<div class="col-md-3">
								<div class="feature">
									...
									<h3 class="feature-title"><strong><i>Re-touch and maintence</i></strong></h3>
							...
							<div class="col-md-3">
								<div class="feature">
									...
									<h3 class="feature-title"><strong><i>Pedicure&medicure</i></strong></h3>
				...
				<div class="fullwidth-block information-section">
					<div class="container">
						...
						<div class="row">
							<div class="col-md-4">
								<figure><img src="images/style.jpg" ></figure>
							</div>
							<div class="col-md-4">
