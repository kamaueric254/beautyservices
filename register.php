...
<body>
  ...
  <div class="container mt-4 shadow">
        ...
        <h1 class="text-center text-uppercase">Beauty We Care</h1>
    </div>
    ...
    <form action="register.php" method="post">
        ...
        <div class="text-center p-3">Already have an account? <a href="login.php">Sign in</a></div>
    </form>
